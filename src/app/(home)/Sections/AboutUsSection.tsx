        ...
        <section className="w-full bg-[#fcd92b] py-16">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-[3fr_1fr] gap-12 items-center">
                    ...
                    {/* Image Card */}
                    <div
                        className="relative w-full max-w-xs mx-auto md:mx-0 aspect-[5/6] rounded-xl overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl"
                    >
                        <Image
